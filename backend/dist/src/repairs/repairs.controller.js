...
let RepairsController = class RepairsController {
    ...
    findAll(user) {
        if (user.role === 'MECHANIC')
            return this.repairsService.findByMechanic(user.id);
        if (user.role === 'CLIENT')
            return this.repairsService.findByClient(user.id);
    ...
    getHistory(id) {
        return this.repairsService.getHistory(+id);
    }
    create(dto) {
    ...
    updateStatus(id, dto, user) {
        return this.repairsService.updateStatus(+id, dto.status, user);
    }
    remove(id, user) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], RepairsController.prototype, "getHistory", null);
__decorate([
    (0, roles_decorator_1.Roles)('ADMIN'),
    (0, common_1.Post)(),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [dto_1.CreateRepairDto]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, dto_1.UpdateRepairDto]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, dto_1.UpdateRepairStatusDto, Object]),
    __metadata("design:returntype", void 0)
