/*
  ...
  - Added the required column `problemDescription` to the `Appointment` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Appointment" ("clientId", "createdAt", "dateTime", "id", "mechanicId", "status", "updatedAt", "vehicleId") SELECT "clientId", "createdAt", "dateTime", "id", "mechanicId", "status", "updatedAt", "vehicleId" FROM "Appointment";
